...
const MESSAGE = `
Happy valentine day 
ขอให้เบ๊บๆรักกับเค้าแบบนี้ไปนานๆ ลดอารมณ์ร้อนลงหน่อย อะไรยอมได้ก็ยอม อยู่เป็นเพื่อนคู่คิด อยู่สร้างอนาคตที่เราวาดไว้ด้วยกันนะ บิวภูมิใจในตัวทิ้วที่สุด สุดหล่อของเค้ารักมากๆนะ  
`;
